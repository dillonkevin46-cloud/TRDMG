...
class TaskForm(forms.ModelForm):
    ...
    def __init__(self, *args, **kwargs):
        ...
        # Relax requirements so the form doesn't fail if the browser omits disabled fields
    ...
    def clean(self):
        ...
        # CRITICAL FIX: Restore original values if the browser omitted them (e.g., from disabled Staff inputs)
        if self.instance and self.instance.pk:
